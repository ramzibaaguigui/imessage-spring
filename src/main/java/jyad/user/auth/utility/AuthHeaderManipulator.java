package jyad.user.auth.utility;

import jyad.user.auth.UserAuth;
...
//        HttpHeaders headers = response.getHeaders();
        ...
        System.out.println(response.getHeaders().get(AUTH_TOKEN_HEADER_KEY));
        System.out.println(response.getHeaders().get(AUTH_TOKEN_ISSUED_AT_HEADER_KEY));
    }
